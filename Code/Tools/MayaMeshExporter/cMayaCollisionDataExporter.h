#ifndef EAE6320_MAYA_COLLISION_DATA_EXPORTER_H
#define EAE6320_MAYA_COLLISION_DATA_EXPORTER_H
...
namespace eae6320
{
	class cMayaCollisionDataExporter : public MPxFileTranslator
	{
	...
	public:
		...
		virtual MString defaultExtension() const { return "cdata"; }
	...
	public:
		...
		static void* Create()
		{
			return new cMayaCollisionDataExporter;
		}
	};
}

#endif	// EAE6320_MAYA_COLLISION_DATA_EXPORTER_H