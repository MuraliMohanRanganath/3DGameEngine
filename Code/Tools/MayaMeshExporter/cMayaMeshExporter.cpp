		...
		if ( fout.is_open() )
		{
				...
				"{\n";
			{
				...
				for (int i = 0; i < i_vertexBuffer.size(); i++)
				{
					...
					fout << "\t\t{\n";
					fout << "\t\t\tposition = {" << i_vertexBuffer[i].vertex.x << ", " << i_vertexBuffer[i].vertex.y << ", " << i_vertexBuffer[i].vertex.z << "},\n";
					fout << "\t\t\tcolor = {" << i_vertexBuffer[i].vertex.r << ", " << i_vertexBuffer[i].vertex.g << ", " << i_vertexBuffer[i].vertex.b << ", " << i_vertexBuffer[i].vertex.a << "},\n";
					fout << "\t\t\ttexture = {" << i_vertexBuffer[i].vertex.u << ", " << i_vertexBuffer[i].vertex.v << "},\n";
					fout << "\t\t},\n";
				}
				fout << "\t},\n";
