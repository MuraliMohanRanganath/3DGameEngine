...
inline bool eae6320::Graphics::RenderStates::IsWireFrameEnabled(const uint8_t i_renderStateBits)
{
	return (i_renderStateBits & WireFrame) != 0;
}
inline void eae6320::Graphics::RenderStates::EnableWireFrame(uint8_t& io_renderStateBits)
{
	io_renderStateBits |= WireFrame;
}
inline void eae6320::Graphics::RenderStates::DisableWireFrame(uint8_t& io_renderStateBits)
{
	io_renderStateBits &= ~WireFrame;
}
...
inline bool eae6320::Graphics::cRenderState::IsWireFrameEnabled() const
{
	return RenderStates::IsWireFrameEnabled(m_bits);
}
